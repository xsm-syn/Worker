...
---------------------------------------------
${VlessMain}
\n<button onclick='copyToClipboard("${VlessMain}")'><i class="fa fa-clipboard"></i> Copy TLS</button>
---------------------------------------------
Vless Ws Port 80
---------------------------------------------
${NTLS}
\n<button onclick='copyToClipboard("${NTLS}")'><i class="fa fa-clipboard"></i> Copy NTLS</button>
---------------------------------------------
Vless WS with IP
---------------------------------------------
${VlessSec}
...
<h1>Vless Account</h1>
  ...
  <head>
	...
	<meta name='twitter:image' content='https://github.com/xsm-syn/ubuntu20/raw/main/logo.png' />
