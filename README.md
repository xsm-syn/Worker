[ENGLISH](https://github.com/xsm-syn/CFW-BOT/blob/main/README.md)
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/xsm-syn/Worker/main/install.sh)"
```
![image](https://github.com/xsm-syn/ubuntu20/raw/main/logo.png)
